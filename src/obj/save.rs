...
mod test {
    ...
    fn test_material_name_collision_resolution() {
        ...
        let cube_roughness = Entity {
            material: Rc::new(
                MaterialBuilder::from(&*cube.material)
        ...
        let loaded = load(obj_path).unwrap();

        assert_eq!(
            2,
            loaded
                .iter()
                .filter(|e| e.material.name() == "Material")
                .count(),
        ...
        assert_eq!(
            ...
            loaded
                .iter()
                .filter(|e| e.material.name() == "Material-Cube")
                .count(),
            "Expecting two entities with material Material"
        );
        ...
        assert_eq!(
            ...
            loaded
                .iter()
                .filter(|e| e.material.name() == "Material-Cube-2")
                .count(),
            "Expecting two entities with material Material"
        );
        ...
        assert_eq!(
            ...
            loaded
                .iter()
                .filter(|e| e.material.name() == "Material-Cube-3")
                .count(),
            "Expecting two entities with material Material"
        );
